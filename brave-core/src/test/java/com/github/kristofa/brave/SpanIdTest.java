...
public class SpanIdTest {
  ...
  @Test public void builderClearsSampled() {
    SpanId id = SpanId.create(1L, 1L, 1L, SpanId.FLAG_SAMPLED | SpanId.FLAG_SAMPLING_SET);
  ...
  @Test public void builderUnsetsDebug() {
    SpanId id = SpanId.create(1L, 1L, 1L, SpanId.FLAG_DEBUG);
  ...
  @Test public void equalsOnlyAccountsForIdFields() {
    assertThat(SpanId.create(1L, 1L, 1L, SpanId.FLAG_DEBUG).hashCode())
        .isEqualTo(SpanId.create(1L, 1L, 1L, SpanId.FLAG_SAMPLING_SET).hashCode());
  }

  @Test public void hashCodeOnlyAccountsForIdFields() {
    assertThat(SpanId.create(1L, 1L, 1L, SpanId.FLAG_DEBUG))
        .isEqualTo(SpanId.create(1L, 1L, 1L, SpanId.FLAG_SAMPLING_SET));
  }
